...
if($rows2>0){
    ...
    echo"<div class='middle' style='height:75%;'>
            <h3 style='margin-left:100px;'>$rows2 Search Results:</h3>
             ...
             foreach( $titleArray as $title1 => $source ) {
                echo "
                        ...
                        <div class='col-md-6' style='font-family: Open Sans; width:250px; text-align: left; padding-left:15px;'>
                            ...
                            <h4 style='font-size:0.8em; font-weight: bold; color:#0288D1;line-height: 20px;'>";
                            if ($divisorCounter!=0) {
                                echo($percent= round((($sum*10)/$divisorCounter)) .'% Occurence');
                            }
                ...
                $query1 = "INSERT into `searching` (user_id,image_url,search_query,percentages,source_name) VALUES ('$id','$urlTitle[$title1]','$in','$percent','$source')";
                            ...
                            // if($result1){
                            //     echo "<div align='center' class='form' style='margin-top: 0;color:#ccc; width: 400px;position:fixed; top: 30%; left: 35%;'><h3 style='color:#ccc;'> <span style='font-size:80px; color:#FFC655'>&#9786;</span><br>SearchQuery successfully inserted.</h3><br/>Click here to <a style='color:#979b1b;' href='signin.php'>Login</a></div>";
                            // }
            }
            echo"</div>
